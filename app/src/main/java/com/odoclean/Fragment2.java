    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent (Fragment2.this.getActivity(), Dfragment_image1.class);
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Intent intent = new Intent (Fragment2.this.getActivity(), Dfragment_image2.class);
                Fragment2.this.getActivity().startActivity(intent);
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Intent intent = new Intent (Fragment2.this.getActivity(), Dfragment_image3.class);
                Fragment2.this.getActivity().startActivity(intent);
            }
        });
